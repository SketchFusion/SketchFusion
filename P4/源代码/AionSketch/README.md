# 1. AionSketch P4 Implementation
...
rm -rf /root/bf-sde-8.9.1/pkgsrc/p4-build/tofinopd/AionSketch
./configure --prefix=$SDE_INSTALL --with-tofino P4_NAME=AionSketch P4_PATH=/root/bf-sde-8.9.1/pkgsrc/p4-examples/programs/AionSketch/AionSketch.p4 P4_VERSION=p4-14 --enable-thrift
make
make install
```
